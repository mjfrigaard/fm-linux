...
## [Background]{style="font-size: 1.05em; font-weight: bold;"} 
...
I’d been an R programmer for over ten years and spent the last five years developing Shiny applications. As a System Admin, my responsibilities included (but were not limited to) maintaining, updating, monitoring and improving the Posit services for CDC users.
...
I was lucky--[DevOps for Data Science (do4ds)](https://do4ds.com/) by [Alex K Gold](https://alexkgold.space/) was written and released (officially) on June 19, 2024, and it is ~80% of the book I wanted to read. The book you are reading is similar to [do4ds](https://do4ds.com/), but I've included topics covered in the following resources: 
...
## [Outline]{style="font-size: 1.05em; font-weight: bold;"}

The first part of this book gradually introduces the Linux environment, starting with some history and operating system basics before moving into more complex concepts. These sections (**Set-Ups**, **Basics**, **Syntax**, **Text**, and **Shell Scripts**) cover concepts and topics for users new to Linux.

Part four of the book covers case studies (or common tasks). 
...
Field Manuals function as both reference material and living documentation, encouraging updates and adaptations based on the given situation, available technology, or broader environment.[^field-manuals]

![Example improvised boobytrap made using a charge and blasting cap.](img/fm531_1965_boobytraps.png){width='70%' fig-align='center'}
  
[^field-manuals]: This definition is based on the [U.S. Army Field Manuals (FMs).](https://github.com/mjfrigaard/fm-linux/tree/main/_assets/1965-fm531-boobytraps.pdf)")
```

### Part One: Introduction

The <strong>@sec-part-one</strong> acquaints you with some background that formed the landscape of Unix systems. It explains the shell, a command-line interface (CLI), which is the gateway to leveraging the full potential of Linux.
...
The data files used in this book are documented in the [data](data.qmd) appendix.
