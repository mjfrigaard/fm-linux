...
The `-P` option lets us specify a pattern to search for in the `data` folder, which we'll cover more in the @sec-special-chars, @sec-wildcards, @sec-regexp, @sec-txt-cmds, and @sec-txt-edit.
