...
Using a car analogy, @sec-shells are the car's dashboards and controls — the interface between the driver and the car’s engine. Shells translate commands into actions a computer can understand and execute. Below I'll cover two popular shells: Bash and Zsh.[^fish]
